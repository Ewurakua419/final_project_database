...
GRANT SELECT
ON Product, Fashion, Beauty, Shipping_Company
TO marketplace_customer;
...
CREATE TABLE Vendor_Credentials (
    ...
    CONSTRAINT fk_vendor_credentials
        FOREIGN KEY (vendor_id)
        REFERENCES Vendor(vendor_id),

    CONSTRAINT chk_vendor_account_status
        CHECK (account_status IN ('ACTIVE', 'LOCKED', 'DISABLED'))
);
